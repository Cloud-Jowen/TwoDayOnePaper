...
(图 1: 一个 Squeeze-and-Excitation 块.)
...
<a id="3.1Squeeze:GlobalInformationEmbedding"></a>
### 3.1. Squeeze: Global Information Embedding
为了解决利用通道相关性的问题，我们首先考虑输出特征中每个通道的信号。每个学习到的滤波器都使用局部感受野进行操作，因此转换输出U的每个单元都无法利用该区域之外的上下文信息。这是一个在网络较低层变得更为严重的问题，因为其感受野尺寸较小。  



<a id="3.3Exemplars:SE-InceptionandSE-ResNet"></a>
